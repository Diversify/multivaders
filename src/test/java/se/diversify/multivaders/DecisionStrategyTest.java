...
import se.diversify.multivaders.strategy.AbstractStrategy;
...
//    }
//
//    private static class TransparentStrategy extends AbstractStrategy {
//
//        @Override
//        public void process(KeyEvent event) {
//            decisionMaker.sendResponse(new KeyEvent(event.getFunction(), event.getClickType()));
//        }
//    }
//
